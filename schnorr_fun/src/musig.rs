...
impl KeyList {
    ...
    pub fn tweak(
        ...
        // new aggregate key with new_tweak
        let agg_key = g!(maybe_negated_agg_key + new_tweak * G)
            .normalize()
            .mark::<NonZero>()?;
        ...
        let tweak = s!(existing_tweak + new_tweak).mark::<Public>();
...
mod test {
    ...
    proptest! {
        ...
        fn musig_prop_test(sk1 in any::<Scalar>(), sk2 in any::<Scalar>(), sk3 in any::<Scalar>(), tweak1 in any::<Scalar<Public, Zero>>(), tweak2 in any::<Scalar<Public, Zero>>(), use_tweak2 in any::<bool>()) {
            ...
            keylist = keylist.tweak(tweak1, true).unwrap();
            if use_tweak2 {
                keylist = keylist.tweak(tweak2, true).unwrap();
            }
